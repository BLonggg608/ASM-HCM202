...
const suggestedPrompts = [
  {
    ...
    text: "Tại sao Bác Hồ nói: Đảng là đạo đức, là văn minh?",
  },
  {
    title: "Bệnh Quan liêu 4.0",
    text: "Các biểu hiện của bệnh quan liêu trong thời đại 4.0 là gì?",
  },
  {
    title: "Trách nhiệm Thanh niên",
    text: "Thanh niên cần làm gì để bảo vệ nền tảng tư tưởng của Đảng trên mạng xã hội?",
  },
  {
    title: "Đức và Tài",
    text: "Phân tích mối quan hệ giữa 'Đức' và 'Tài' theo tư tưởng Hồ Chí Minh.",
  },
];
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            >
              ...
              Trợ lý AI - Đảng Cộng sản Việt Nam: Đạo đức, Văn minh & Khát vọng 4.0
            </Title>
          </div>
        </div>
      </Header>
              ...
              {messages.length === 0 ? (
                ...
                <div className="welcome-screen">
                  <div className="welcome-title">
                    Tư tưởng Hồ Chí Minh & Khát vọng 4.0
                  </div>
                  <div className="welcome-subtitle">
                    Trợ lý AI chuyên gia về Xây dựng Đảng "Đạo đức, Văn minh" và
                    Vận dụng trong Kỷ nguyên số. Hãy bắt đầu cuộc trò chuyện
                    bằng cách chọn một chủ đề bên dưới.
                  </div>
